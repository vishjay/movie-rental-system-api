        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Addresses_MailingAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentalInvoiceId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryRentals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InventoryRentals_InventoryItems_InventoryItemId",
                        column: x => x.InventoryItemId,
                        principalTable: "InventoryItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryRentals_Rentals_RentalInvoiceId",
                        column: x => x.RentalInvoiceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryRentals_InventoryItemId",
                table: "InventoryRentals",
                column: "InventoryItemId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryRentals_RentalInvoiceId",
                table: "InventoryRentals",
                column: "RentalInvoiceId");
